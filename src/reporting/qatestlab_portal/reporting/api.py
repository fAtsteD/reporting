...
class ReportingApi:
    ...
    def categories_bindings(self) -> Iterable[CategoryBinding]:
        ...
        return (
            ...
            for category_binding in response_data
        )
    ...
    def corp_struct_items(self) -> Iterable[CorpStructItem]:
        ...
        return (
            ...
            for corp_struct_item in response_data
        )
    ...
    def employees_positions(self) -> Iterable[EmployeePosition]:
        ...
        return (
            ...
            for employee_position in response_data
        )
    ...
    def login(self, login: str, password: str) -> bool:
        ...
        try:
            ...
            raise PortalRequestException("Portal reporting API login has bad body", response=response)
    ...
    def logout(self) -> None:
        ...
        try:
            ...
            raise PortalRequestException("Portal reporting API logout has bad body", response=response)
    ...
    def providers(self) -> tuple[Iterable[Client], Iterable[Project]]:
        ...
        return (
            (
                ...
                for client in response_data["clients"]
            ),
            (
                Project(
        ...
        return (
            Report(
                ...
                timeRecords=[
                    ...
                    for task in report["timeRecords"]
                ],
            )
    ...
    def time_record_save(self, time_records: Iterable[TimeRecord]) -> Iterable[TimeRecord]:
        ...
        return (
            ...
            for time_record in response_data
        )
